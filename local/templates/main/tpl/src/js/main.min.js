		...
		App.points.data.forEach(function (group) {
			...
			group['points'].forEach(function (point) {
				var placemark = new ymaps.Placemark(point.coords.map(function (x) {
					...
					balloonContentBody: '<div class="marker__descr"> ' + '<div class="marker__descr-name">' + point.name + '</div> ' + '<div class="marker__descr-content">' + 'Телефон: <span>' + point.phone + '</span><br/>' + 'Почта: <span>' + point.email + '</span><br/>' + 'Адрес: <span>' + point.address + '</span>' +
